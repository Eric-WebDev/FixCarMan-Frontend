...
export default class AdStore {
  ...
  @computed get getCarMake() {
    return this.rootStore.vehicleStore.vehicle?.carMake;
  }
  ...
  groupAdsByDate(ads: IAdvert[]) {
    const sortedAds = ads.sort((a, b) => a.date.getTime() - b.date.getTime());
    return Object.entries(
      sortedAds.reduce((ads, ad) => {
