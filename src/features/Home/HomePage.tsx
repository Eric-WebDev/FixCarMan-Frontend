  ...
  <Segment>
    <Grid stackable>
      ...
      <Grid.Column width={8} textAlign="center" verticalAlign="middle">
        <Responsive />
        <Header as="h2" content="Place where you can find the best services" />
        <Button
          as={Link}
          to="/jobs"
          basic
          ...
          {isLoggedIn && user && token ? (
            ...
            <Fragment>
              <Header
                as="h2"
                inverted
                content={`Register or log in to see adverts !!!`}
              />
              <Button
          ...
          <Grid.Row>
            <Grid.Column width={8}>
              <Header as="h2" style={{ fontSize: "2em" }} textAlign="center">
                We are connecting Car Owners with Profesional and trusted Car
                Services
              </Header>
              <p style={{ fontSize: "1.33em" }}>
                We are providing simple to use and free connection platform for
                car owners and car services in Ireland. Getting someone to fix
                your car has never been more comfortable. We can help to find
                qualified, and trusted garage or specialized advise.
              </p>
            </Grid.Column>
